...
print ''
print '<img src="{{ \'assets/images/%s/%s/price.jpg\' | relative_url }}" alt="price" class="image featured">' % (keycapstype, name.lower().replace(" ",""))
print ''
...
print """
## Pictures"""
picpath = 'assets/images/%s/%s/rendering_pics/' % (keycapstype, name.lower().replace(" ",""))
pictures = [f for f in listdir(picpath)]
for pic in pictures:
   print '<img src="{{ \'assets/images/%s/%s/rendering_pics/%s\' | relative_url }}" alt="%s" class="image featured">' % ( keycapstype, name.lower().replace(" ",""), pic, pic.replace(".jpg","") )
